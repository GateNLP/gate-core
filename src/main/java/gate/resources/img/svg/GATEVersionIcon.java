...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(166.99379, 251.58516);
((GeneralPath)shape).lineTo(174.46774, 251.58516);
((GeneralPath)shape).lineTo(174.46774, 253.7987);
((GeneralPath)shape).lineTo(169.38962, 253.7987);
((GeneralPath)shape).lineTo(169.38962, 255.60078);
((GeneralPath)shape).quadTo(169.73337, 255.50703, 170.08232, 255.45757);
((GeneralPath)shape).quadTo(170.43129, 255.40808, 170.80629, 255.40808);
((GeneralPath)shape).quadTo(172.9365, 255.40808, 174.124, 256.47318);
((GeneralPath)shape).quadTo(175.3115, 257.5383, 175.3115, 259.44455);
((GeneralPath)shape).quadTo(175.3115, 261.33517, 174.01982, 262.40808);
((GeneralPath)shape).quadTo(172.72816, 263.481, 170.43129, 263.481);
((GeneralPath)shape).quadTo(169.4365, 263.481, 168.46513, 263.2883);
((GeneralPath)shape).quadTo(167.49379, 263.09558, 166.53024, 262.70496);
((GeneralPath)shape).lineTo(166.53024, 260.33517);
((GeneralPath)shape).quadTo(167.48337, 260.88205, 168.34013, 261.1555);
((GeneralPath)shape).quadTo(169.19691, 261.42892, 169.95212, 261.42892);
((GeneralPath)shape).quadTo(171.04587, 261.42892, 171.67607, 260.89505);
((GeneralPath)shape).quadTo(172.30629, 260.3612, 172.30629, 259.44455);
((GeneralPath)shape).quadTo(172.30629, 258.52267, 171.67607, 257.99142);
((GeneralPath)shape).quadTo(171.04587, 257.46017, 169.95212, 257.46017);
((GeneralPath)shape).quadTo(169.30629, 257.46017, 168.57191, 257.62943);
((GeneralPath)shape).quadTo(167.83754, 257.7987, 166.99379, 258.14767);
((GeneralPath)shape).lineTo(166.99379, 251.58516);
((GeneralPath)shape).closePath();
paint = getColor(0, 128, 0, 255, disabled);
g.setPaint(paint);
g.fill(shape);

...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(47.944557, 1045.8121);
((GeneralPath)shape).quadTo(47.944557, 1043.6246, 47.5357, 1042.7288);
((GeneralPath)shape).quadTo(47.12685, 1041.833, 46.1581, 1041.833);
((GeneralPath)shape).quadTo(45.18935, 1041.833, 44.775288, 1042.7288);
((GeneralPath)shape).quadTo(44.361225, 1043.6246, 44.361225, 1045.8121);
((GeneralPath)shape).quadTo(44.361225, 1048.0205, 44.775288, 1048.9268);
((GeneralPath)shape).quadTo(45.18935, 1049.833, 46.1581, 1049.833);
((GeneralPath)shape).quadTo(47.116432, 1049.833, 47.530495, 1048.9268);
((GeneralPath)shape).quadTo(47.944557, 1048.0205, 47.944557, 1045.8121);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(50.954975, 1045.833);
((GeneralPath)shape).quadTo(50.954975, 1048.734, 49.704975, 1050.3096);
((GeneralPath)shape).quadTo(48.454975, 1051.885, 46.1581, 1051.885);
((GeneralPath)shape).quadTo(43.850807, 1051.885, 42.600807, 1050.3096);
((GeneralPath)shape).quadTo(41.350807, 1048.734, 41.350807, 1045.833);
((GeneralPath)shape).quadTo(41.350807, 1042.9268, 42.600807, 1041.3538);
((GeneralPath)shape).quadTo(43.850807, 1039.7809, 46.1581, 1039.7809);
((GeneralPath)shape).quadTo(48.454975, 1039.7809, 49.704975, 1041.3538);
((GeneralPath)shape).quadTo(50.954975, 1042.9268, 50.954975, 1045.833);
((GeneralPath)shape).closePath();

...
g.setClip(clip_);
	...
	public ApplicationsIcon(boolean disabled) {
	...
	public ApplicationsIcon(Dimension size, boolean disabled) {
	...
	public ApplicationsIcon(int width, int height, boolean disabled) {
		this.width = width;
		this.height = height;

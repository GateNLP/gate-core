...
public class CorpusBenchmarkIcon implements
		javax.swing.Icon {
...
g.transform(new AffineTransform(0.8790990114212036f, 0.0f, 0.0f, 0.8147389888763428f, 7.678196907043457f, 6.72633695602417f));
...
// _0_0_0_4 is TextNode of 'GATE  CORPUS'
...
g.transform(new AffineTransform(-0.502934992313385f, -0.8235120177268982f, -1.0631239414215088f, 0.4272629916667938f, 98.38037109375f, 36.647361755371094f));
...
shape = new Rectangle2D.Double(0.5, 50.5, 64.0, 11.0);
g.setPaint(paint);
g.fill(shape);
paint = getColor(0, 0, 0, 255, disabled);
...
paint = getColor(0, 0, 0, 255, disabled);
stroke = new BasicStroke(1.4051899f,0,0,4.0f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(31.724976, 50.83331);
((GeneralPath)shape).curveTo(31.724976, 58.731544, 31.724976, 57.7415, 31.724976, 57.7415);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(1.0f,0,0,4.0f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(39.962185, 50.981255);
((GeneralPath)shape).curveTo(39.962185, 54.981255, 39.962185, 54.479855, 39.962185, 54.479855);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
paint = getColor(0, 0, 0, 255, disabled);
stroke = new BasicStroke(1.367057f,0,0,4.0f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(47.72569, 50.780193);
((GeneralPath)shape).curveTo(47.72569, 58.255573, 47.72569, 57.318535, 47.72569, 57.318535);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(1.0f,0,0,4.0f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(55.5, 50.981255);
((GeneralPath)shape).curveTo(55.5, 54.981255, 55.5, 54.479855, 55.5, 54.479855);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(1.0f,0,0,4.0f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(23.5, 50.981255);
((GeneralPath)shape).curveTo(23.5, 54.981255, 23.5, 54.479855, 23.5, 54.479855);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
paint = getColor(0, 0, 0, 255, disabled);
stroke = new BasicStroke(1.4254194f,0,0,4.0f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(15.28729, 50.71271);
((GeneralPath)shape).curveTo(15.28729, 58.839993, 15.28729, 57.821236, 15.28729, 57.821236);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
stroke = new BasicStroke(1.0f,0,0,4.0f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(7.5, 50.981255);
((GeneralPath)shape).curveTo(7.5, 54.981255, 7.5, 54.479855, 7.5, 54.479855);
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
g.setClip(clip_);
	...
	public CorpusBenchmarkIcon(boolean disabled) {
	 ...
	 */
	public CorpusBenchmarkIcon(Dimension size) {
		this(size.width, size.height, false);
	}
	
	public CorpusBenchmarkIcon(Dimension size, boolean disabled) {
		this(size.width, size.height, disabled);
	}

	public CorpusBenchmarkIcon(int width, int height) {
		this(width, height, false);
	}
	
	public CorpusBenchmarkIcon(int width, int height, boolean disabled) {
		this.width = width;
		this.height = height;

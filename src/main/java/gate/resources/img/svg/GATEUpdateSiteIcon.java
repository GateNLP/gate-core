...
g.setPaint(paint);
g.fill(shape);
paint = getColor(140, 0, 0, 255, disabled);
...
g.setClip(clip_);
	...
	public GATEUpdateSiteIcon(boolean disabled) {
	...
	public GATEUpdateSiteIcon(Dimension size, boolean disabled) {
	...
	public GATEUpdateSiteIcon(int width, int height, boolean disabled) {
		this.width = width;
		this.height = height;

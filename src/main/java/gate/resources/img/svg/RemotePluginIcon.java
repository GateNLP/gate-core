...
g.setClip(clip_);
	...
	public RemotePluginIcon(boolean disabled) {
	...
	public RemotePluginIcon(Dimension size, boolean disabled) {
	...
	public RemotePluginIcon(int width, int height, boolean disabled) {
		this.width = width;
		this.height = height;
